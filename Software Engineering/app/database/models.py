...
from app.constants import ALL_DELETE_ORPHAN, STOCK_GREATER_EQUAL_ZERO
...
class Topping(Base):
    ...
    stock: Mapped[int] = mapped_column(CheckConstraint(STOCK_GREATER_EQUAL_ZERO), nullable=False)
